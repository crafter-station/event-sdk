    ...
    <section className="py-20 px-6" id="faq">
      <div className="mx-auto max-w-3xl">
        <div className="text-center mb-12">
          <p className="font-mono text-xs text-[var(--accent)] tracking-widest uppercase mb-2">FAQ</p>
        ...
        <div className="space-y-2">
          {faqConfig.items.map((item, i) => (
            <div key={item.question} className="rounded-lg border border-white/5 bg-[var(--surface)] overflow-hidden">
              <button
                type="button"

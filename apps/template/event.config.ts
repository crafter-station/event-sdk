...
const event = defineEvent({
  ...
  features: {
    ...
    sponsors: {
      tiers: [
        { id: "diamond", name: "Diamond", slug: "diamond", price: 500000, color: "#B9F2FF", benefits: ["Logo on stage", "5 min pitch", "Booth", "10 tickets", "Hiring booth"] },
        { id: "gold", name: "Gold", slug: "gold", price: 250000, color: "#FFD700", benefits: ["Logo on site", "Booth", "5 tickets", "Hiring booth"] },
        { id: "silver", name: "Silver", slug: "silver", price: 100000, color: "#C0C0C0", benefits: ["Logo on site", "3 tickets"] },
        { id: "bronze", name: "Bronze", slug: "bronze", price: 50000, color: "#CD7F32", benefits: ["Logo on site", "1 ticket"] },
      ],
      ctaUrl: "/deck",
      ctaLabel: "Become a Sponsor",
      deckSlides: [
        { variant: "cover" as const, title: "Peru AI Hackathon 2026" },
        { variant: "opportunity" as const, title: "Why Sponsor?", content: "Connect with 500+ developers and AI enthusiasts building the future of Peru's tech ecosystem." },
        ...
        { variant: "contact" as const, title: "Get In Touch", content: "sponsors@peru-ai-hackathon.co" },
      ],
    },
    ...
    hackathon: {
      enabled: true,
      tracks: [
        { name: "AI for Education", slug: "ai-education", description: "Build tools that make education more accessible.", color: "#00FF87" },
        { name: "AI for Health", slug: "ai-health", description: "Healthcare solutions powered by AI.", color: "#FF6B6B" },
        { name: "AI for Climate", slug: "ai-climate", description: "Sustainability and environmental AI.", color: "#4ECDC4" },
        { name: "Open Track", slug: "open", description: "Build anything with AI.", color: "#FFE66D" },
      ],
    ...
    faq: {
      items: [
        { question: "Who can participate?", answer: "Anyone! Students, professionals, hobbyists — all skill levels welcome." },
        ...
        { question: "What should I bring?", answer: "Your laptop, charger, and enthusiasm. We provide food and drinks." },

      ...
      <main className="pt-20 px-6 pb-20">
        <div className="mx-auto max-w-2xl">
          <div className="text-center mb-12">
            <p className="font-mono text-xs text-[var(--accent)] tracking-widest uppercase mb-2">Badge</p>
            ...
            <p className="mt-4 text-sm text-[var(--muted)]">Generate your personalized event badge with 3D particles.</p>
          </div>
          <BadgeGenerator />
        </div>
      </main>

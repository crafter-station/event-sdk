...
const PLACEHOLDER_JUDGES = [
	...
	},
	{
		...
		company: "Rappi",
		expertise: ["System Design", "ML Ops"],
	},
	{
		name: "Sofia Mendez",
		title: "Founder",
		company: "LatamTech",
		expertise: ["Product", "AI Strategy"],
	},
	{
		name: "Roberto Silva",
		title: "Professor",
		company: "UNMSM",
		expertise: ["Algorithms", "Theoretical CS"],
	},
];
				...
				<div className="mx-auto max-w-6xl">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
						{PLACEHOLDER_JUDGES.map((j) => (
							<div
								key={j.name}
								className="rounded-lg border border-white/5 bg-[var(--surface)] p-6 text-center"
							>
								...
								<div className="mt-3 flex flex-wrap gap-1 justify-center">
									{j.expertise.map((tag) => (
										<span
											key={tag}
											className="rounded-full border border-white/10 px-2 py-0.5 text-[10px] text-[var(--muted)]"
										>
											{tag}
										</span>
									))}
